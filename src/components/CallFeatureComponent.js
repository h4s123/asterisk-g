...
//     if (type === "recording") {
//       const validTypes = ["audio/ulaw", "audio/wav", "audio/alaw"]; // Add allowed MIME types
//       if (!validTypes.includes(file.type)) {
//         alert("Please upload a valid audio file (ulaw or alaw or WAV).");
//         return;
//       }
...
//         { text: textToSpeech }
//       );
//       toast.success(response.data.message || "Text converted to speech and uploaded successfully.");
...
//       toast.success(response.data.message || `${type} file uploaded successfully.`);
...
//         `${process.env.NEXT_PUBLIC_API_BASE_URL || "http://localhost:5000/api"}/recordings/start-calls`
//       );
//       toast.success(response.data.message || "Calls started successfully.");
//     } catch (error) {
//       console.error("Error starting calls:", error);
...
//       <div>
//         <label className="block mb-2 font-medium">Convert and Upload:</label>
//         <textarea
//           className="w-full p-2 border rounded"
//           rows="4"
//           value={textToSpeech}
...
//           onClick={handleTextToSpeech}
//           className="mt-2 px-4 py-2 bg-green-500 text-white rounded hover:bg-green-600"
//           disabled={loading || !!recordingFile}
//         >
//           Convert and Upload
//         </button>
//       </div>
...
//       <div>
//         <label className="block mb-2 font-medium">Upload List of Numbers:</label>
//         <input
//           type="file"
//           accept=".txt"
//           onChange={(e) => handleFileUpload(e, "numbers")}
